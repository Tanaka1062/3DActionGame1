...
// ============================================================
//		CEffekseerCtrl  静的メンバ定義
// ============================================================
std::vector<EffekseerSingle>			CEffekseerCtrl::m_eff;
std::vector<::Effekseer::EffectRef>		CEffekseerCtrl::m_effect;
::EffekseerRendererDX11::RendererRef	CEffekseerCtrl::m_renderer = nullptr;
::Effekseer::ManagerRef					CEffekseerCtrl::m_manager  = nullptr;
int										CEffekseerCtrl::m_allNum   = 0;
int										CEffekseerCtrl::m_useID    = 0;
...
//		内部ヘルパー: レンダラー取得
//---------------------------------
::EffekseerRenderer::RendererRef CEffekseerCtrl::GetRenderer()
{
