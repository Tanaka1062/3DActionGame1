...
static const float FRAME_PATE = 60.0f;									//1秒辺りのフレーム数
static const float FRAME_RATE_MILLI_SECOND = 1000.0f / FRAME_PATE;		//何ミリ秒で1フレームか
...
void CFps::Print()
{
	...
	//DrawFormatString(550, 32, GetColor(0, 255, 0), "FPS:%.2f", m_frameRate);
}